...
function MenuPost(props) {
    ...
    return (
        ...
        <div class="post-content">
            <img src={props.postImage} alt="Foto do post" onClick={() => like(true)}/>
        </div>
        {/* <!-- Post Content End --> */}
        ...
        <div class="bottom-post-infos">
            ...
            <div class="liked-by-infos">
                ...
                <div class="liked-by-desc">
                    <span>Curtido por <strong>{props.commentUser}</strong> e <strong>outras 101.523 pessoas</strong></span>
                </div>
            </div>
            {/* <!-- Liked by infos End--> */}
        </div>
